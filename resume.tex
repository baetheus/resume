...
Offered consulting services covering \textbf{software engineering}, \textbf{systems administration}, \textbf{custom application development}, \textbf{break fix}, and general \textbf{web development}.

\split{Ntersol}{Senior Frontend Engineer}{July 2019 - December 2019}
Implemented \textbf{functional programming} paradigms in \textbf{Angular}. Defined and implemented standard practices for \textbf{api integration}, \textbf{ui structure}, and \textbf{semantic component design}. Created code generators for \textbf{api validation}, \textbf{error handling}, \textbf{logging}, and \textbf{caching} in frontend applications.

\split{Lodasoft}{Senior Software Engineer}{July 2018 - July 2019}
Designed and built highly dynamic production web portals for loan agents and borrowers to manage document submission and validation. Designed and built a generalized task tree builder and runner in \textbf{Angular}. Implemented \textbf{batched logging} from the front end, a front end \textbf{monorepo}, and \textbf{application documentation} practices.
